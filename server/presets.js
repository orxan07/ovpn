...
const PRESETS = [
  ...
  },
  {
    ...
    domains: [
      ...
      'cdn.whatsapp.net', 'g.whatsapp.net', 'graph.whatsapp.com',
      'pps.whatsapp.net', 'v.whatsapp.net',
      // Медиа, аватарки, превью ссылок и Graph иногда уходят
      // не через whatsapp.net, а через CDN-хосты Meta.
      'graph.facebook.com', 'fbcdn.net', 'fbsbx.com',
      'lookaside.fbsbx.com',
    ],
    ipCidr: [
